...
function getQuote() {
    $.ajax({
        ...
        success: function(response) {
            ...
            if (inIframe()) {
                $('#tweet-quote').attr('href', 'https://twitter.com/intent/' +
                'tweet?hashtags=quotes&related=freecodecamp&text=' +
                encodeURIComponent('"' + currentQuote + '" ' + currentAuthor));
                $('#tumblr-quote').attr('href', 'https://www.tumblr.com/widgets' +
                '/share/tool?posttype=quote&tags=quotes,freecodecamp&caption='
